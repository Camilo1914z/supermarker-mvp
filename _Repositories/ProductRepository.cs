    ...
    internal class ProductRepository : BaseRepository, IProductRepository
    {
        ...
        public void Add(ProductModel productModel)
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                command.CommandText = "INSERT INTO Product VALUES (@name, @description)";
                command.Parameters.Add("@name", SqlDbType.NVarChar).Value = productModel.Name;
                command.Parameters.Add("@descrption", SqlDbType.NVarChar).Value = productModel.Description;
            ...
            using (var command = new SqlCommand())
            {
                ...
                using (var reader = command.ExecuteReader())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        productModel.Description = reader["Product_Description"].ToString();
        ...
        public IEnumerable<ProductModel> GetByValue(string value)
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                command.CommandText = @"SELECT * FROM Product
                                        WHERE Product_Id=@id  or Product_Name                           
                                        LIKE @name+ '&'
